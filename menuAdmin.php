  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#cca">Crear Cuenta</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#eca">Editar Cuenta</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#bca">Borrar Cuenta</a>
          </li>
        </ul>
      </div>
    </nav>
...
<?php
 ...
 <div class="form-group">
  ...
  <button type="submit" class="btn btn-success btn-block">Guardar</button>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="cca">
        <div class="my-auto">
   ...
   <form  action="controlador/crearcuenta.php" method="post">
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="dpi" placeholder="cliente">
  </div>
  
  <div class="form-group">
    <label for="cliente">Saldo:</label>
    <input type="text" class="form-control" name="saldo" placeholder="TotalSaldo">
  </div>
  <button type="submit" class="btn btn-success btn-block">Guardar</button>
</form>
</div>
