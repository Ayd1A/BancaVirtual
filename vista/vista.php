...
<link href="librerias/css/resume.min.css" rel="stylesheet">
	  ...
	  <h1>Usuarios</h1>
       <?php
		...
		print "<script>window.location='../indexError.html';</script>";
			...
			$user_name=$pd[0]["nombres"];
			$tipo=$pd[0]["user_type"];
		    $user2=$pd2[0];	
			session_start();
			$_SESSION['user_name']=$user_name;//para administracion
			$_SESSION['user1']=$user2;//para usuario normal
  ...
  <strong>Bienvenido </strong>NO esta autorizado a ver este contenido, logueese primero
</div>
